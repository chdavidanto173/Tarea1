...
func makeGetPublisherByBookEndpoint(s PublishersBooksService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(GetPublisherByBookRequest)
		publisherBookDetails, err := s.GetPublisherByBook(ctx, req.Id)
		if err != nil {
			return GetPublisherByBookResponse{Publisher: publisherBookDetails, Err: "Id not found"}, nil
		}
		return GetPublisherByBookResponse{Publisher: publisherBookDetails, Err: ""}, nil
	}
}

func makeGetBooksByPublisherEndpoint(s PublishersBooksService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(GetBooksByPublisherRequest)
		publisherBooksDetails, err := s.GetBooksByPublisher(ctx, req.Id)
		if err != nil {
			return GetBooksByPublisherResponse{Book: publisherBooksDetails, Err: "Id not found"}, nil
		}
		return GetBooksByPublisherResponse{Book: publisherBooksDetails, Err: ""}, nil
	}
}

func decodeGetPublisherByBookRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req GetPublisherByBookRequest
	fmt.Println("-------->>>>into GetByBook Decoding")
	vars := mux.Vars(r)
	req = GetPublisherByBookRequest{
		Id: vars["bookid"],
	}
	return req, nil
}

func decodeGetBooksByPublisherRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req GetBooksByPublisherRequest
	fmt.Println("-------->>>>into GetByBook Decoding")
	vars := mux.Vars(r)
	req = GetBooksByPublisherRequest{
		Id: vars["publisherid"],
	}
	return req, nil
}

func encodeResponsePublishersBook(_ context.Context, w http.ResponseWriter, response interface{}) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	fmt.Println("into Encoding <<<<<<----------------")
	return json.NewEncoder(w).Encode(response)
}
...
type (
	GetPublisherByBookRequest struct {
		Id string `json:"bookid"`
	}
	GetPublisherByBookResponse struct {
		Publisher interface{} `json:"publisher,omitempty"`
		Err       string      `json:"error,omitempty"`
	}
)
...
type (
	GetBooksByPublisherRequest struct {
		Id string `json:"publisherid"`
	}
	GetBooksByPublisherResponse struct {
		Book interface{} `json:"book,omitempty"`
		Err  string      `json:"error,omitempty"`
	}
)

func makeGetAuthorByBookEndpoint(s AuthorsBooksService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(GetAuthorByBookRequest)
		AuthorBookDetails, err := s.GetAuthorByBook(ctx, req.Id)
		if err != nil {
			return GetAuthorByBookResponse{Author: AuthorBookDetails, Err: "Id not found"}, nil
		}
		return GetAuthorByBookResponse{Author: AuthorBookDetails, Err: ""}, nil
	}
}

func makeGetBooksByAuthorEndpoint(s AuthorsBooksService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(GetBooksByAuthorRequest)
		AuthorBooksDetails, err := s.GetBooksByAuthor(ctx, req.Id)
		if err != nil {
			return GetBooksByAuthorResponse{Book: AuthorBooksDetails, Err: "Id not found"}, nil
		}
		return GetBooksByAuthorResponse{Book: AuthorBooksDetails, Err: ""}, nil
	}
}

func decodeGetAuthorByBookRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req GetAuthorByBookRequest
	fmt.Println("-------->>>>into GetByBook Decoding")
	vars := mux.Vars(r)
	req = GetAuthorByBookRequest{
		Id: vars["bookid"],
	}
	return req, nil
}

func decodeGetBooksByAuthorRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req GetBooksByAuthorRequest
	fmt.Println("-------->>>>into GetByBook Decoding")
	vars := mux.Vars(r)
	req = GetBooksByAuthorRequest{
		Id: vars["authorid"],
	}
	return req, nil
}

func encodeResponseAuthorsBook(_ context.Context, w http.ResponseWriter, response interface{}) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	fmt.Println("into Encoding <<<<<<----------------")
	return json.NewEncoder(w).Encode(response)
}
...
type (
	GetAuthorByBookRequest struct {
		Id string `json:"bookid"`
	}
	GetAuthorByBookResponse struct {
		Author interface{} `json:"Author,omitempty"`
		Err    string      `json:"error,omitempty"`
	}
)
...
type (
	...
	GetBooksByAuthorResponse struct {
		Book interface{} `json:"Book,omitempty"`
		Err  string      `json:"error,omitempty"`
	}
)
